    ...
    <div className={styles.container}>
      ...
      <section className={commonStyles.container}>
        ...
        <div className={styles.postInfoContainer}>
          <div>
            <FiCalendar /> <span>{format(new Date(post.first_publication_date), 'dd MMM yyyy').toLowerCase()}</span>
          </div>
...
export const getStaticProps: GetStaticProps = async ({ params }: QueryProps) => {
  const prismic = getPrismicClient({});
